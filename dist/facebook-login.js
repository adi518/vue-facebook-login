...
Component.options.__file = "C:\\projects\\facebook-login-vue\\src\\facebook-login.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] facebook-login.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0af1f3c3", Component.options)
  } else {
    hotAPI.reload("data-v-0af1f3c3", Component.options)
  }
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["c"] = loadFbSdk;
/* harmony export (immutable) */ __webpack_exports__["d"] = getLoginStatus;
/* harmony export (immutable) */ __webpack_exports__["b"] = fbLogin;
/* harmony export (immutable) */ __webpack_exports__["a"] = fbLogout;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "facebookLoginPlugin", function() { return facebookLoginPlugin; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__facebook_login_vue__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__facebook_login_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__facebook_login_vue__);

var facebookLoginPlugin = {
  install: function install(Vue, options) {
    Vue.component(__WEBPACK_IMPORTED_MODULE_0__facebook_login_vue___default.a.name, __WEBPACK_IMPORTED_MODULE_0__facebook_login_vue___default.a);
  }
};
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__facebook_login_vue___default.a);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__icon_png__ = __webpack_require__(76);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      isWorking: false,
      isConnected: false,
      icon: __WEBPACK_IMPORTED_MODULE_1__icon_png___default.a
    };
  },
  ...
  methods: {
    ...
    logout: function logout() {
      ...
      this.isWorking = true;
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["a" /* fbLogout */])().then(function (response) {
        _this.isWorking = false;
        _this.isConnected = false;
        _this.$emit('logout', response);
      });
    },
    login: function login() {
      ...
      this.isWorking = true;
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["b" /* fbLogin */])(this.loginOptions).then(function (response) {
  ...
  mounted: function mounted() {
    ...
    this.isWorking = true;
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["c" /* loadFbSdk */])(this.appId, this.version).then(function (loadingResult) {}).then(function () {
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__helpers_js__["d" /* getLoginStatus */])();
    }).then(function (response) {
      if (response.status === 'connected') {
        _this3.isConnected = true;
      }
      _this3.isWorking = false;
      _this3.$emit('get-initial-status', response);
    });
  }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [(_vm.isWorking) ? _c('div', {
    staticClass: "spinner"
  }) : _vm._e(), _vm._v(" "), (!_vm.isWorking) ? _c('img', {
    attrs: {
      "src": _vm.icon
    }
  }) : _vm._e(), _vm._v(" " + _vm._s(_vm.getButtonText) + "\n  ")])])
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-0af1f3c3", module.exports)
  }
}
...
var update = __webpack_require__(80)("05ca2c48", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../node_modules/css-loader/index.js?{\"minimize\":false,\"sourceMap\":false}!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0af1f3c3\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./facebook-login.vue", function() {
     var newContent = require("!!../node_modules/css-loader/index.js?{\"minimize\":false,\"sourceMap\":false}!../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-0af1f3c3\",\"scoped\":true,\"hasInlineConfig\":false}!../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./facebook-login.vue");
